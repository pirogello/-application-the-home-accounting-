...
public class AccountAddEditDialog extends AddEditDialog{
    ...
    protected void init() {
        ...
        components.put("LABEL_CURRENCY", new CommonComboBox(SaveData.getInstance().getEnableCurrency().toArray()));
    ...
    public Common getCommonFromForm() throws ModelExeption {
        try {
            ...
            return new Account(title, currency, Format.fromAmountToNumb(startAmount));
